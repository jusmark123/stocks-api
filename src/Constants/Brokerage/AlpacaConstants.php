...
final class AlpacaConstants
{
    ...
    const ORDER_INFO_ENTITY_CLASS = 'App\DTO\Brokerage\Alpaca\AlpacaOrderInfo';
    ...
    const SERIALIZATION_CONFIG = '/opt/app-root/src/config/serialization/alpaca_account_info.yml';
